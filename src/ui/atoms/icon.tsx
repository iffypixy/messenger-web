...
const getIcon = ({name, ...props}: Props) => {
  switch (name) {
    ...
    case "play":
      return (
        <Svg width="2.5rem"
             height="2.5rem" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
             viewBox="0 0 30.051 30.051" xmlSpace="preserve" {...props}>
          <g>
    ...
    case "audio":
      return (
        <Svg width="2rem" height="2rem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 477.867 477.867"
